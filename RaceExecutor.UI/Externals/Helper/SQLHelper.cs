...
namespace RaceExecutor.UI.Externals.Helper
{
        ...
        public class AdoHelper : IDisposable
        {
            ...
            public AdoHelper()
            {
                //Uncomment for local server connection
                //_connString = ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString.ToString();
                _connString = ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString.ToString();
                //ConnectionString;
                Connect();
            }
            ...
            public DataSet ExecDataSet(string qry, params object[] args)
            {
                ...
                //conn.ConnectionString = @"Data Source=ACACIA;Initial Catalog=RawQueryGenerator;Persist Security Info=True;User ID=sa;Password=adminadmin" +
